...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Comment.slug'
        db.add_column(u'content_comment', 'slug',
                      self.gf('django.db.models.fields.SlugField')(default=datetime.datetime(2014, 9, 12, 0, 0), max_length=200),
                      keep_default=False)

        # Adding unique constraint on 'Comment', fields ['post', 'slug']
        db.create_unique(u'content_comment', ['post_id', 'slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'Comment', fields ['post', 'slug']
        db.delete_unique(u'content_comment', ['post_id', 'slug'])

        # Deleting field 'Comment.slug'
        db.delete_column(u'content_comment', 'slug')
    ...
    models = {
        ...
        u'content.comment': {
            'Meta': {'unique_together': "(('post', 'slug'),)", 'object_name': 'Comment'},
            'created_on': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'post': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['content.Post']", 'null': 'True', 'on_delete': 'models.PROTECT'}),
